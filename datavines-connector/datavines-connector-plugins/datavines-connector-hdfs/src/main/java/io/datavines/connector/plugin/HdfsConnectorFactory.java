 ...
 * @DATE: 2024/2/5
 */
public class HdfsConnectorFactory implements ConnectorFactory {
    @Override
    ...
    public ResponseConverter getResponseConverter() {
        return new HdfsResponseConverter();
    }

    @Override
    public Dialect getDialect() {
        return new HdfsDialect();
    }

    @Override
    public ConnectorParameterConverter getConnectorParameterConverter() {
        return new HdfsConnectorParameterConverter();
    }
    ...
    public TypeConverter getTypeConverter() {
        return new HdfsTypeConverter();
    }

    @Override
    public ConfigBuilder getConfigBuilder() {
        return new HdfsConfigBuilder();
    }
